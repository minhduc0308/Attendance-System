...
<!--          <a href="timetable">Weekly Timetable</a>-->
      ...
      <div class="menu-btn">
        ...
        <form action="UpdateLecture" method="post" >
            ID: <input type="text" name="id" value="${lecture.id}" required readonly><br>
            Name: <input type="text" name="name" value="${lecture.name}" required><br>
            Date of Birth: <input type="date" name="dob" value="${lecture.dob}" required><br>
            Email: <input type="text" name="email" value="${lecture.email}" required><br>
