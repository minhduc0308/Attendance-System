<%-- 
    Document   : AddNews
    Created on : Mar 30, 2024, 11:04:13 PM
    Author     : ASUS
--%>
...
<html>
    ...
    <body>
        ...
        <br>
        <h1>Add News</h1>
        <form action="AddNews" method="post" onsubmit="return validateForm()">
            <label for="title">Title:</label><br>
            <input type="text" id="title" name="title" required onblur="checkTitleLength()"><br>

            <label for="description">Description:</label><br>
            <textarea id="description" name="description" required onblur="checkDescriptionLength()"></textarea><br>
